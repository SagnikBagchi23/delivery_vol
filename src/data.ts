...
export const RANGE_DATA: Record<RangeKey, RangeData> = {
  daily: {
    ...
    bars: [
      ...
      { label: '29 Jul', total: 88, delivery: 30, totalDisplay: '22,40,900', deliveryDisplay: '7,64,700', percentDisplay: '34.12%', periodLabel: '29 Jul, 2025' },
      ...
      { label: '1 Aug*', total: 120, delivery: 48, totalDisplay: '32,10,450', deliveryDisplay: '12,18,300', percentDisplay: '37.93%', periodLabel: '1 Aug, 2025' },
    ],
  },
  weekly: {
    ...
    bars: [
      { label: '30 Jun', total: 90, delivery: 28, totalDisplay: '1,18,20,400', deliveryDisplay: '39,80,200', percentDisplay: '33.67%', periodLabel: '23-29 Jun, 2025' },
      { label: '7 Jul', total: 82, delivery: 26, totalDisplay: '1,08,60,700', deliveryDisplay: '36,50,100', percentDisplay: '33.62%', periodLabel: '30 Jun-6 Jul, 2025' },
      { label: '10-16 Jul', total: 75, delivery: 24, totalDisplay: '99,40,800', deliveryDisplay: '32,10,450', percentDisplay: '32.30%', periodLabel: '10-16 Jul, 2025' },
      { label: '24 Jul', total: 98, delivery: 34, totalDisplay: '1,29,90,300', deliveryDisplay: '45,60,500', percentDisplay: '35.11%', periodLabel: '17-23 Jul, 2025' },
      { label: '31 Jul*', total: 120, delivery: 44, totalDisplay: '1,58,30,100', deliveryDisplay: '58,70,900', percentDisplay: '37.08%', periodLabel: '24-31 Jul, 2025' },
    ],
  },
  monthly: {
