...
export const RANGE_DATA: Record<RangeKey, RangeData> = {
  ...
  weekly: {
    ...
    bars: [
      { label: '29 Jun', total: 90, delivery: 28, totalDisplay: '1,18,20,400', deliveryDisplay: '39,80,200', percentDisplay: '33.67%', periodLabel: '23-29 Jun, 2025' },
      { label: '6 Jul', total: 82, delivery: 26, totalDisplay: '1,08,60,700', deliveryDisplay: '36,50,100', percentDisplay: '33.62%', periodLabel: '30 Jun-6 Jul, 2025' },
      { label: '16 Jul', total: 75, delivery: 24, totalDisplay: '99,40,800', deliveryDisplay: '32,10,450', percentDisplay: '32.30%', periodLabel: '10-16 Jul, 2025' },
      { label: '23 Jul', total: 98, delivery: 34, totalDisplay: '1,29,90,300', deliveryDisplay: '45,60,500', percentDisplay: '35.11%', periodLabel: '17-23 Jul, 2025' },
